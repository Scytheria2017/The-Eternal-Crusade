...
bool Guardian::InitStatsForLevel(uint8 petlevel)
{
    ...
    if (IsPet() && GetOwner()->GetTypeId() == TYPEID_PLAYER)
    {
        if (GetOwner()->GetClass() == CLASS_WARLOCK
            ...
            || GetOwner()->GetClass() == CLASS_DEATH_KNIGHT
    ...
    else                                           
    {
        ...
        SetCreateStat(STAT_STAMINA, 22);
        SetCreateStat(STAT_INTELLECT, 20);
        SetCreateStat(STAT_SPIRIT, 20);
    }
    ...
    switch (petType)
    {
        ...
        case HUNTER_PET:
        {
            ...
            SetBaseWeaponDamage(BASE_ATTACK, MINDAMAGE, strength * 0.75f);
            SetBaseWeaponDamage(BASE_ATTACK, MAXDAMAGE, strength * 1.25f);
            break;
        }
        default:
        {
